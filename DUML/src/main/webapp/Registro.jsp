...
<body>
	...
	<form method="post" action="<%=request.getContextPath()%>/Registro.do">
		<input type="text"  class="form-control" placeholder="Login" name="login"> <input
			type="password"  class="form-control" placeholder="Password" name="password"> <input
			type="text"  class="form-control" placeholder="Nombre" name="nombre"> <input
			type="text"  class="form-control" placeholder="Primer Apellido" name="primer_ap"> <input
			type="text"  class="form-control" placeholder="Segundo Apellido" name="segundo_ap">
